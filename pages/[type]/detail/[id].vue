...
<template>
  <section class="flex p-5 my-2 bg-white rounded">
    <NImage
  ...
  <NGrid :x-gap="20" class="pt-2">
    <NGridItem :span="18">
      <section class="mb-5 bg-white rounded shadow-white">
        <Tabs
          :data="tabs"
          :state="curr"
          @change="curr = $event"
        ...
        <div
          v-if="curr === 'detail'"
          class="px-10 pt-4 pb-10 content"
    ...
    <NGridItem :span="6">
      <section class="mb-5 bg-white rounded shawdow">
